<?xml version="1.0" encoding="UTF-8"?><cfLuceeConfiguration hspw="b161efba3a9cae2973c128ebea00ae9333c529e28e60a2680f290d1e87ef4a7c" salt="23B3C462-AD49-4A28-86211C22271C7628" version="4.5"><cfabort/>
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="511" blob="true" class="org.gjt.mm.mysql.Driver" clob="true" connectionTimeout="1" custom="useUnicode=true&amp;characterEncoding=UTF-8&amp;jdbcCompliantTruncation=true&amp;useLegacyDatetimeCode=true" database="wheelstestdb" dbdriver="MySQL" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" metaCacheTimeout="60000" name="wheelstestdb" port="3306" storage="false" username="root" validate="false"/></data-sources>
